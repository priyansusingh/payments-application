  ...
  return (
    <div className="h-screen flex flex-col">
      <header className="w-full flex justify-between items-center shadow px-4 sm:px-14 py-4 bg-white">
        <div className="text-xl sm:text-2xl font-bold text-black-600">
          Payments App
        </div>
        <div className="flex justify-between items-center gap-2">
          <button
            onClick={() => navigate("/signup")}
            className="rounded-md bg-black hover:text-grey-700 text-white border border-black-700 py-2 font-medium px-5 hover:cursor-pointer focus:outline-none"
          >
            Signup
          </button>
          <button
